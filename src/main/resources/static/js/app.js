    ...
    $.extend(simpleCart.prototype, {
                                ...
                                <div class='cart-offer'></div>\n\
                                        <div class='cart-total-amount'>\n\
                                            ...
                                            <form action='#' id='cartForm'>\n\
                                             <div class='add-button'><button  type='submit' class='btn btn-primary'>PROCEED TO CHECKOUT</button></div>\n\
                                            </form>\n\
                                        </div>\n\
                                 </div>");
        ...
        _ajaxPost: function() {
            $.ajax({
                ...
                url : window.location + "post/instant/order",
                ...
                success : function(result) {
                    if(result.status == "OK"){
                        $("#postResultDiv").html("<p style='background-color:#7FA7B0; color:white; padding:20px 20px 20px 20px'>" +
                            ...
                            "---> Resut Status= " + result.status + "<br>"+
                            "---> Result Status Code = "+ result.statusCode);
                    }
                    else{
                        $("#postResultDiv").html("<strong>result</strong>");
                    }
                    console.log(result);
                },
                error : function(e) {
